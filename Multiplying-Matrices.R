# -----------------------------------------------------------------------------
# R Script Multiplying-Matrices.R
# Author: Gene Gallant
# Date: October 18th, 2023
# Description: A script to demonstrate multiplying matrices in R
# -----------------------------------------------------------------------------
...
######################################################
# Multiplying two 5 x 5 matrix of sequential numbers #
######################################################

display_title("Multiplying Matrices")

cat("\n")

print_heading("Multiplying two 5 x 5 matrices with %*% operator")
cat("Matrix 1\n\n")
...
######################################################
# Multiplying two 4 x 4 matrices with random numbers #
######################################################

print_heading("Multiplying two 4 x 4 matrices with random numbers")
...
########################################################
# Multiplying two 3 x 3 matrices with specific numbers #
########################################################

print_heading("Multiplying two 3 x 3 matrices with specific numbers")
...
######################################################################
# Multiplying two 3 x 3 matrices with column-wise sequential numbers #
######################################################################

print_heading("Multiplying two 3 x 3 matrices with column-wise sequential numbers")
