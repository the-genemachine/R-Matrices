# -----------------------------------------------------------------------------
# R Script Subtracting-Matrices.R
# Author: Gene Gallant
# Date: October 18th, 2023
# Description: A script to demonstrate subtracting matrices in R
# -----------------------------------------------------------------------------
...
# [The print_heading and display_title functions remain the same]

######################################################
# Subtracting two 5 x 5 matrix of sequential numbers #
######################################################

display_title("Subtracting Matrices")

cat("\n")

print_heading("Subtracting two 5 x 5 matrices with - operator")
cat("Matrix 1\n\n")
...
######################################################
# Subtracting two 4 x 4 matrices with random numbers #
######################################################

print_heading("Subtracting two 4 x 4 matrices with random numbers")
...
########################################################
# Subtracting two 3 x 3 matrices with specific numbers #
########################################################

print_heading("Subtracting two 3 x 3 matrices with specific numbers")
...
######################################################################
# Subtracting two 3 x 3 matrices with column-wise sequential numbers #
######################################################################

print_heading("Subtracting two 3 x 3 matrices with column-wise sequential numbers")
